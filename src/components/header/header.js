          ...
          <div
            ...
            <ul className="lg:flex lg:gap-x-8 max-lg:space-y-2">
              ...
              <li className="max-lg:border-b max-lg:border-gray-300 max-lg:py-3"><p 
                className="hover:text-[#6863af] font-medium text-black block text-[15px]"><Link href="/#category">Category</Link></p> </li>
              <li className="max-lg:border-b max-lg:border-gray-300 max-lg:py-3"><p 
                className="hover:text-[#6863af] font-medium text-black block text-[15px]"><Link href="/#products">Product</Link></p> </li>
